...
export declare const KeePass2: Readonly<{
	readonly innerStreamSalsa20IV: Uint8Array;
...
export function readKdbxFile(keys: KdbxKey[], fileBytes: Buffer | Uint8Array | number[]): Promise<KdbxFile>;
export function writeKdbxFile(keys: KdbxKey[], file: KdbxFile): Promise<Uint8Array>;
