...
export const sampleDatabaseFeatures: Database = {
  metadata: {
    generator: 'KeePassXC',
    name: 'Passwords',
    nameChanged: new Date('2024-06-15T14:41:20.000Z'),
    description: 'Lots of features used',
    descriptionChanged: new Date('2024-06-15T14:40:31.000Z'),
    defaultUserName: 'user@example.com',
    defaultUserNameChanged: new Date('2024-06-15T05:51:55.000Z'),
    maintenanceHistoryDays: 365,
    color: '',
    masterKeyChanged: new Date('2024-06-13T00:41:08.000Z'),
    ...
    customIcons: {
      '7e1dc2ab-f493-44c1-8847-919d4ee18020': {
        ...
        name: 'js',
        lastModificationTime: new Date('2024-06-15T05:44:31.000Z'),
        data: jsIcon,
      },
    },
    recycleBinEnabled: true,
    recycleBinUuid: 'cf4fa281-5c0b-463e-b411-b0221d5bfb22',
    recycleBinChanged: new Date('2024-06-15T05:48:34.000Z'),
    entryTemplatesGroup: '00000000-0000-0000-0000-000000000000',
    entryTemplatesGroupChanged: new Date('2024-06-13T00:40:30.000Z'),
    ...
    settingsChanged: new Date('2024-06-15T14:41:20.000Z'),
  },
  root: {
    group: {
      ...
      timeInfo: {
        lastModificationTime: new Date('2024-06-15T06:01:29.000Z'),
        creationTime: new Date('2024-06-13T00:40:30.000Z'),
        lastAccessTime: new Date('2024-06-15T06:01:29.000Z'),
        expiryTime: new Date('2024-06-13T00:40:30.000Z'),
        expires: false,
        usageCount: 0,
        locationChanged: new Date('2024-06-13T00:40:30.000Z'),
      },
      isExpanded: true,
      ...
      entries: [
        {
          ...
          tags: '',
          timeInfo: {
            lastModificationTime: new Date('2024-06-13T00:43:03.000Z'),
            creationTime: new Date('2024-06-13T00:42:14.000Z'),
            lastAccessTime: new Date('2024-06-13T00:43:03.000Z'),
            expiryTime: new Date('2024-06-13T00:42:14.000Z'),
            expires: false,
            usageCount: 0,
        ...
        },
        {
          ...
          tags: '',
          timeInfo: {
            lastModificationTime: new Date('2024-06-15T06:06:41.000Z'),
            creationTime: new Date('2024-06-15T05:49:07.000Z'),
            lastAccessTime: new Date('2024-06-15T06:06:41.000Z'),
            expiryTime: new Date('2024-06-15T05:49:07.000Z'),
            expires: false,
            usageCount: 0,
          ...
          history: [
            {
              ...
              tags: '',
              timeInfo: {
                lastModificationTime: new Date('2024-06-15T05:49:13.000Z'),
                creationTime: new Date('2024-06-15T05:49:07.000Z'),
                lastAccessTime: new Date('2024-06-15T05:49:13.000Z'),
                expiryTime: new Date('2024-06-15T05:49:07.000Z'),
                expires: false,
                usageCount: 0,
                locationChanged: new Date('2024-06-15T05:49:13.000Z'),
            ...
            },
            {
              ...
              tags: '',
              timeInfo: {
                lastModificationTime: new Date('2024-06-15T05:49:23.000Z'),
                creationTime: new Date('2024-06-15T05:49:07.000Z'),
                lastAccessTime: new Date('2024-06-15T05:49:23.000Z'),
                expiryTime: new Date('2024-06-15T05:49:07.000Z'),
                expires: false,
                usageCount: 0,
                locationChanged: new Date('2024-06-15T05:49:13.000Z'),
            ...
            },
            {
              ...
              tags: '',
              timeInfo: {
                lastModificationTime: new Date('2024-06-15T05:50:03.000Z'),
                creationTime: new Date('2024-06-15T05:49:07.000Z'),
                lastAccessTime: new Date('2024-06-15T05:50:03.000Z'),
                expiryTime: new Date('2024-06-15T05:49:07.000Z'),
                expires: false,
                usageCount: 0,
                locationChanged: new Date('2024-06-15T05:49:13.000Z'),
      ...
      children: [
        {
          ...
          timeInfo: {
            lastModificationTime: new Date('2024-06-15T05:50:38.000Z'),
            creationTime: new Date('2024-06-15T05:43:32.000Z'),
            lastAccessTime: new Date('2024-06-15T05:50:38.000Z'),
            expiryTime: new Date('3000-06-15T05:43:32.000Z'),
            expires: true,
            usageCount: 0,
            locationChanged: new Date('2024-06-15T05:45:04.000Z'),
          },
          isExpanded: true,
          ...
          entries: [
            {
              ...
              timeInfo: {
                lastModificationTime: new Date('2024-06-15T06:02:24.000Z'),
                creationTime: new Date('2024-06-15T05:45:07.000Z'),
                lastAccessTime: new Date('2024-06-15T06:02:24.000Z'),
                expiryTime: new Date('2500-06-15T05:45:47.000Z'),
                expires: true,
                usageCount: 0,
              ...
              history: [
                {
                  ...
                  timeInfo: {
                    lastModificationTime: new Date('2024-06-15T05:47:56.000Z'),
                    creationTime: new Date('2024-06-15T05:45:07.000Z'),
                    lastAccessTime: new Date('2024-06-15T05:47:56.000Z'),
                    expiryTime: new Date('2500-06-15T05:45:47.000Z'),
                    expires: true,
                    usageCount: 0,
                    locationChanged: new Date('2024-06-15T05:47:56.000Z'),
        ...
        },
        {
          ...
          iconNumber: DefaultIconNumber.Folder,
          timeInfo: {
            lastModificationTime: new Date('2024-06-15T14:36:34.000Z'),
            creationTime: new Date('2024-06-15T06:01:40.000Z'),
            lastAccessTime: new Date('2024-06-15T14:36:34.000Z'),
            expiryTime: new Date('2024-06-15T06:01:40.000Z'),
            expires: false,
            usageCount: 0,
            locationChanged: new Date('2024-06-15T06:01:49.000Z'),
          },
          isExpanded: false,
          defaultAutoTypeSequence: '',
          enableAutoType: NullableBoolean.Inherit,
          ...
          children: [
            {
              ...
              timeInfo: {
                lastModificationTime: new Date('2024-06-15T06:02:02.000Z'),
                creationTime: new Date('2024-06-15T06:01:51.000Z'),
                lastAccessTime: new Date('2024-06-15T06:02:02.000Z'),
                expiryTime: new Date('2024-06-15T06:01:51.000Z'),
                expires: false,
                usageCount: 0,
                locationChanged: new Date('2024-06-15T06:02:02.000Z'),
              },
              isExpanded: true,
              defaultAutoTypeSequence: '',
              enableAutoType: NullableBoolean.Inherit,
        ...
        },
        {
          ...
          timeInfo: {
            lastModificationTime: new Date('2024-06-15T06:01:45.000Z'),
            creationTime: new Date('2024-06-15T05:48:34.000Z'),
            lastAccessTime: new Date('2024-06-15T06:01:45.000Z'),
            expiryTime: new Date('2024-06-15T05:48:34.000Z'),
            expires: false,
            usageCount: 0,
            locationChanged: new Date('2024-06-15T05:48:34.000Z'),
          },
          isExpanded: true,
          defaultAutoTypeSequence: '',
          ...
          entries: [
            {
              ...
              tags: '',
              timeInfo: {
                lastModificationTime: new Date('2024-06-15T06:01:19.000Z'),
                creationTime: new Date('2024-06-15T06:01:11.000Z'),
                lastAccessTime: new Date('2024-06-15T06:01:19.000Z'),
                expiryTime: new Date('2024-06-15T06:01:11.000Z'),
                expires: false,
                usageCount: 0,
                locationChanged: new Date('2024-06-15T06:01:19.000Z'),
              },
          ...
          children: [
            {
              ...
              timeInfo: {
                lastModificationTime: new Date('2024-06-15T05:50:38.000Z'),
                creationTime: new Date('2024-06-15T05:48:10.000Z'),
                lastAccessTime: new Date('2024-06-15T05:50:38.000Z'),
                expiryTime: new Date('2024-06-15T05:48:10.000Z'),
                expires: false,
                usageCount: 0,
                locationChanged: new Date('2024-06-15T05:48:43.000Z'),
              },
              isExpanded: true,
              defaultAutoTypeSequence: '',
              enableAutoType: NullableBoolean.Inherit,
              ...
              entries: [
                {
                  ...
                  tags: '',
                  timeInfo: {
                    lastModificationTime: new Date('2024-06-15T05:48:41.000Z'),
                    creationTime: new Date('2024-06-15T05:48:18.000Z'),
                    lastAccessTime: new Date('2024-06-15T05:48:41.000Z'),
                    expiryTime: new Date('2024-06-15T05:48:18.000Z'),
                    expires: false,
                    usageCount: 0,
                    locationChanged: new Date('2024-06-15T05:48:41.000Z'),
                  },
    ...
    deletedObjects: [
      {
        deletionTime: new Date('2024-06-15T06:01:32.000Z'),
